          ...
          {categories.map((category) => (
            ...
            >
              <div className="w-28 md:w-32 text-center">
                <div className="w-28 h-28 md:w-32 md:h-32 rounded-full overflow-hidden mb-2 border-4 border-transparent group-hover:border-orange-400 transition-all duration-300 transform group-hover:scale-105 shadow-lg">
                  <img
                    src={category.image}
                    alt={category.name}
