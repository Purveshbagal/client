    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
      ...
      <nav className="flex justify-between items-center px-4 md:px-12 py-4 md:py-6">
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <h1 className="text-xl md:text-3xl font-black text-gray-900">Swadhan Eats</h1>
        </div>
        <button
          onClick={() => navigate('/login')}
          className="px-4 md:px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg hover:from-orange-600 hover:to-red-600 transition-all font-semibold text-sm md:text-base"
        >
          Sign In
        </button>
      </nav>
      ...
      <div className="container mx-auto px-4 md:px-12 py-6 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-700 px-3 md:px-4 py-2 rounded-full mb-3 font-semibold text-xs md:text-sm">
              <span>⚡</span>
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4">
              <div>
                <div className="flex items-center gap-1 md:gap-2 mb-1">
                  ...
                  <span className="text-lg md:text-xl font-bold text-gray-900">30 min</span>
                </div>
              ...
              <div>
                <div className="flex items-center gap-1 md:gap-2 mb-1">
                  ...
                  <span className="text-lg md:text-xl font-bold text-gray-900">500+</span>
                </div>
                <p className="text-xs text-gray-600">Restaurants</p>
              </div>
              <div>
                <div className="text-lg md:text-xl font-bold text-gray-900 mb-1">⭐ 4.8</div>
      ...
      {/* Features Section */}
      <div className="bg-white py-8 md:py-16 border-t border-gray-200">
        <div className="container mx-auto px-4 md:px-12">
          <h3 className="text-xl md:text-2xl font-bold text-center text-gray-900 mb-8 md:mb-10">Why Choose Us?</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Lightning Fast</h4>
              <p className="text-sm md:text-base text-gray-600">Delivered in 30 minutes or less, guaranteed</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Top Rated</h4>
              <p className="text-sm md:text-base text-gray-600">Only the best restaurants in your city</p>
            </div>

            {/* Feature 3 */}
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-pink-100 rounded-full mb-4">
                <span className="text-2xl md:text-3xl">📦</span>
              </div>
              <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Fresh & Quality</h4>
              <p className="text-sm md:text-base text-gray-600">Fresh ingredients guaranteed in every order</p>
            </div>
          </div>
        </div>
      </div>
